 ...
 * 调用通联接口 查询卡信息
 */
public class QueryCardInfoUtil {

    public static String queryCardInfo(String cardId) throws Exception {
        ...
        String method1 = TongLianCardConfig.QUERY_CARD_INFO_METHOD; //系统参数 接口名称
