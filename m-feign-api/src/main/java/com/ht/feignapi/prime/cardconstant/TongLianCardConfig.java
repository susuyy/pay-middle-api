...
public class TongLianCardConfig {
     ...
     * 系统参数 接口名称 金额支付
     */
    public static final String PAY_WITH_PASSWORD_CLOUD = "allinpay.card.cloud.paywithpassword.add";

    /**
     * 系统参数 接口名称 金额支付
     */
    public static final String PAY_WITH_PASSWORD = "allinpay.card.paywithpassword.add";
