...
public class CardMoneyPayUtil {
    ...
    public static String CardMoneyPay(String amountMoney, String cardId, String orderCode) throws HttpException, IOException {
        ...
        String method1 = TongLianCardConfig.PAY_WITH_PASSWORD_CLOUD; //系统参数 接口名称
