 ...
 * 调取通联开卡接口
 */
public class BindProductCardUtil {
    public static String bindproduct(String cardId,String prdtNo) throws HttpException, IOException {
        ...
        String method1 = TongLianCardConfig.BIND_PRODUCT; //系统参数 接口名称
        ...
        arrayList.add(new NameValuePair("opr_id", opr_id));
