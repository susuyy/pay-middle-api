...
class MarkDownApplicationTests {
    ...
    void contextLoads() {
        ...
        config.setServerUrl("https://gateway.hualta.com/m-feign-api/");
        ...
        config.setOutPath("D:\\个人\\feign-api-tonglian\\prime");
        // @since 1.2,如果不配置该选项，则默认匹配全部的controller,
        // 如果需要配置有多个controller可以使用逗号隔开
        config.setPackageFilters("com.ht.feignapi.prime.controller");
