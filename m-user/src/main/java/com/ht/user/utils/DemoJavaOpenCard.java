...
public class DemoJavaOpenCard {
    public static void main(String[] args) throws HttpException, IOException {
        ...
        String method1 = "allinpay.ppcs.cloud.card.open"; //系统参数 接口名称
...
//        treeMap.put("card_id", card_id1);
        ...
        arrayList.add(new NameValuePair("password", "111111"));
