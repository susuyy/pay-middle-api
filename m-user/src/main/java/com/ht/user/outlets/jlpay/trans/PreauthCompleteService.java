...
import com.jlpay.ext.qrcode.trans.request.PreauthCompleteRequest;
import com.jlpay.ext.qrcode.trans.response.PreauthCompleteResponse;
import com.jlpay.ext.qrcode.trans.service.TransExecuteService;
import org.apache.commons.lang3.RandomStringUtils;

public class PreauthCompleteService {
    static {
        //设置系统参数
    ...
    public static void main(String[] args) {
        //组装请求参数
        PreauthCompleteRequest request = componentRequestData();
        //交易请求
        PreauthCompleteResponse response = TransExecuteService.executor(request, PreauthCompleteResponse.class);
        System.out.println("返回参数=========>" + JSON.toJSON(response));

    }

    private static PreauthCompleteRequest componentRequestData() {
        ...
        request.setOriOutTradeNo("BS0655433688");//商家系统内部原订单号   机构下唯一
        request.setOriTransactionId("8001158120200914103029264109");//原预授权嘉联订单号，
        request.setGuaranteeAuthCode("007452");//原授权码交易返回的授权码
